...
export default class Terminal extends React.Component<{}, TerminalState> {
      ...
      <div key={`terminal-input-row-${id}`} flex>
        <div className="w-max hstack space-x-1.5">
          <span text-yellow-200>
            mason@macbook-pro <span text-green-300>{this.getCurDirName()}</span>
          </span>
  ...
  render() {
    return (
      <div
        className="terminal font-terminal font-normal relative h-full bg-gray-800/90 overflow-y-scroll cursor-default"
        text="white sm"
