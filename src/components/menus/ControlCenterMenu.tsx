...
export default function ControlCenterMenu({
  ...
  return (
    ...
    >
      ...
      <div
        className="cc-grid flex-center flex-col cursor-pointer"
      ...
      <div className="cc-grid col-span-4 hstack space-x-2.5" p="y-2 l-2 r-4">
        ...
        {playing ? (
          <span className="i-bi:pause-fill text-2xl cursor-pointer" onClick={() => toggleAudio(false)} />
        ) : (
          <span className="i-bi:play-fill text-2xl cursor-pointer" onClick={() => toggleAudio(true)} />
        )}
      </div>
    </div>
  );
