  ...
  return (
    <div
      className={`w-full h-8 px-2 fixed top-0 hstack justify-between ${
        props.hide ? "z-0" : "z-20"
      } text-sm backdrop-blur-2xl shadow transition text-white bg-gradient-to-r from-[grey] to-[grey]`}
    >
      ...
      <div className="hstack flex-row justify-end space-x-2">
        ...
        <TopBarItem ref={spotlightBtnRef} className="cursor-pointer" onClick={props.toggleSpotlight}>
